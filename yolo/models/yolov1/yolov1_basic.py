...
def get_conv2d(c1, c2, k, p, s, d, g, bias=False):
    # d (dilation)：卷积膨胀系数，控制卷积核元素之间的间距。默认为1表示标准卷积，大于1时使用空洞卷积，可以在不增加参数的情况下扩大感受野。
    # g (groups)：分组卷积，将输入按组划分，每组分别进行卷积，最后将各组结果拼接起来。特别地，当 g = 输入通道数 时，就是深度可分离卷积(depthwise convolution)。
